...
feature2 = get_point_block_markov(matrix_abs, T);
feature3 = get_point_block_markov(matrix_dif_c_1, T);
feature4 = get_point_block_markov(matrix_dif_r_1, T);
feature5 = get_point_block_markov(matrix_dif_c_2, T);
feature6 = get_point_block_markov(matrix_dif_r_2, T);

feature7 = get_point_block_markov(matrix_abs_dif_c_1, T);
feature8 = get_point_block_markov(matrix_abs_dif_r_1, T);
feature9 = get_point_block_markov(matrix_abs_dif_c_2, T);
feature10 = get_point_block_markov(matrix_abs_dif_r_2, T);
