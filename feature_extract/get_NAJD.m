%% Extract accumulative neighboring joint density (提取邻域累积联合密度特征)
% - feature = get_NAJD(matrix, directions, T, order)
% - Variables:
% ------------------------------------------input
...
function feature = get_NAJD(matrix, directions, T, order)
