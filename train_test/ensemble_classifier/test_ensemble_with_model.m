...
% - result = test_ensemble_with_model(cover_feature, stego_feature, trained_ensemble, is_figure)
% - Variable:
% ------------------------------------------input
% cover_feature         the feature of cover samples
% stego_feature         the feature of stego samples
% trained_ensemble      model used for test in the memory
% -----------------------------------------output
% result                result
...
function result = test_ensemble_with_model(cover_feature, stego_feature, trained_ensemble, is_figure)
